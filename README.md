...
---
## Services and resources worth checking out
> ℹ️ In no particular order, and not sponsored; just a list of things I use.

- **Signal** - E2EE messenger (🌎 [web](https://signal.org/), ⬇️ [download page](https://signal.org/download/))
- **Ente.io** - Safe home for your photos. End-to-end encrypted. Cross-platform. Open-source. (🌎 [web](https://ente.io/))
  - _shameless referral code plug: `HW79QE` (+10GB)_
- **NextDNS** - The new firewall for the modern Internet. (🌎 [web](https://nextdns.io/))
- **Mullvad VPN** - Privacy is for the people ([web](https://mullvad.net))


- **Techlore** - Digital Rights for All (🌎 [web](https://techlore.tech/))
  - Privacy & Security Resources (🌎 [web](https://privacytools.techlore.tech/))
  - VPN Comparison Tool (🌎 [web](https://vpn.techlore.tech/))
- **Naomi Brockwell** - Empower yourself. (▶️ [YouTube](https://www.youtube.com/@NaomiBrockwellTV), 🌎[web](https://www.nbtv.media/))
- **Firewalls Don't Stop Dragons** - Security and Privacy Blog for Non-Techies (🌎 [web](https://firewallsdontstopdragons.com/))
- **Surveillance Report** - Weekly News for Your Digital Freedom  ([web](https://surveillancereport.tech/))
- **The New Oil** - The Beginner’s Guide to Data Privacy & Cybersecurity (🌎 [web](https://thenewoil.org/))
- **The Electronic Frontier Foundation (EFF)** - Defending your rights in the digital world (🌎 [web](https://www.eff.org/))
- **Privacy Guides** (🌎 [web](https://privacyguides.org/))
